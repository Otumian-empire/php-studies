		...
		<div class="container">
			...
			<div>
				...
				<form method="POST" action="<?=htmlspecialchars($_SERVER['PHP_SELF']);?>">
					<div>
						Email: <input type="email" value="<?=$_POST['email']??'';?>" name="email" placeholder="email"/>
						<br>
						<?php echo "<span>$emailError</span>";?>
						<br>
						
						password: <input type="password" value="<?=$_POST['password']??'';?>" name="password" placeholder="password"/>
						<br>
					...
					<div>
						message: <textarea name="message" placeholder="message" cols="60%" rows="10%"><?=$_POST['message']??'';?></textarea>
						<br>
